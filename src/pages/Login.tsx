            ...
            <div className="h-[20rem] w-[20rem] bg-sky-50 border-2 border-pink-500 rounded-lg flex flex-col justify-between items-center">
                ...
                <div className="w-full flex flex-col justify-center items-center">
                    <div className="w-full flex justify-center items-center">
                        <button className="w-[94%] py-1 bg-green-400 hover:bg-green-600 rounded-full border-2 border-green-600 text-white font-bold transition-colors" type="button">Login</button>
                    </div>
                    <div className="mt-2 mb-4">
                        <Link to={"/resetpassword"} className="text-sm">Forget password?</Link>
                    </div>
                </div>
            </div>
        </div>
